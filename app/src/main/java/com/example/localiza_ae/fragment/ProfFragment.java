...
public class ProfFragment extends Fragment {
    ...
    private TextView textProf;  // Variavel para chara o Frag Professor
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textProf = view.findViewById(R.id.textAluno);
        textProf.setText("Professo Alterado"); // altera o fragment professor
